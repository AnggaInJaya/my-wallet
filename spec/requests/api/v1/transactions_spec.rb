...
RSpec.describe 'Api::V1::Transactions', type: :request do
  ...
  describe 'POST /api/v1/transactions/deposit' do
    ...
    it 'returns unprocessable_content missing params' do
      post '/api/v1/transactions/deposit',
           headers: { 'Authorization' => "Bearer #{jwt}" }
  ...
  describe 'POST /api/v1/transactions/withdraw' do
    ...
    it 'returns unprocessable_content with missing amount' do
      post '/api/v1/transactions/withdraw',
           headers: { 'Authorization' => "Bearer #{jwt}" }
  ...
  describe 'POST /api/v1/transactions/transfer' do
    ...
    it 'returns not_found with missing destination_wallet_id' do
      post '/api/v1/transactions/transfer',
           headers: { 'Authorization' => "Bearer #{jwt}" },
           params: { amount: 10 }
